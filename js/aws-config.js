...
const aws_bots_config = '[{"name":"","alias":"$LATEST","description":"Bot to Questionnaire.","bot-template":"bot-flowers","commands-help":["I would like to pick up flowers","I would like to order some flowers","Buy flowers"],"region":"eu-west-2"}]';
